export const ADD_USER_PROFILE_LINK = 'addUserProfileLink';
...
export const PROFILE_SET = 'profileSet';
...
export const UNSET_CURRENT_USER_CREDS = 'unsetCurrentUserCreds';

export default {
  ADD_USER_PROFILE_LINK,
  CHANGE_USERNAME,
  LOGIN_SET_EMAIL,
  LOGIN_SET_PASSWORD,
  PROFILE_SET,
